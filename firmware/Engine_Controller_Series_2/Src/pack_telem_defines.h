...
/// Last autogenerated: Fri May 18 01:27:21 2018
...
#define	TELEM_ITEM_97	((int16_t) (LOG_TO_AUTO*1)) >> 0 
#define	TELEM_ITEM_98	((int16_t) (LOG_TO_AUTO*1)) >> 8 
#define	TELEM_ITEM_99	((uint16_t) (auto_states*1)) >> 0 
#define	TELEM_ITEM_100	((uint16_t) (auto_states*1)) >> 8 
#define	TELEM_ITEM_101	((int32_t) (e3v*100)) >> 0 
#define	TELEM_ITEM_102	((int32_t) (e3v*100)) >> 8 
#define	TELEM_ITEM_103	((int32_t) (e3v*100)) >> 16 
#define	TELEM_ITEM_104	((int32_t) (e3v*100)) >> 24 
#define	TELEM_ITEM_105	((int32_t) (e5v*100)) >> 0 
#define	TELEM_ITEM_106	((int32_t) (e5v*100)) >> 8 
#define	TELEM_ITEM_107	((int32_t) (e5v*100)) >> 16 
#define	TELEM_ITEM_108	((int32_t) (e5v*100)) >> 24 
#define	TELEM_ITEM_109	((uint16_t) (BOARD_ID*1)) >> 0 
#define	TELEM_ITEM_110	((uint16_t) (BOARD_ID*1)) >> 8 
#define	TELEM_ITEM_111	((uint16_t) (last_packet_number*1)) >> 0 
#define	TELEM_ITEM_112	((uint16_t) (last_packet_number*1)) >> 8 
#define	TELEM_ITEM_113	((uint16_t) (last_command_id*1)) >> 0 
#define	TELEM_ITEM_114	((uint16_t) (last_command_id*1)) >> 8 
#define	TELEM_ITEM_115	((uint16_t) (imtr[0]*1000)) >> 0 
#define	TELEM_ITEM_116	((uint16_t) (imtr[0]*1000)) >> 8 
#define	TELEM_ITEM_117	((uint16_t) (imtr[1]*1000)) >> 0 
#define	TELEM_ITEM_118	((uint16_t) (imtr[1]*1000)) >> 8 
#define	TELEM_ITEM_119	((uint16_t) (tbrd*10)) >> 0 
#define	TELEM_ITEM_120	((uint16_t) (tbrd*10)) >> 8 
#define	TELEM_ITEM_121	((uint16_t) (tvlv*10)) >> 0 
#define	TELEM_ITEM_122	((uint16_t) (tvlv*10)) >> 8 
#define	TELEM_ITEM_123	((uint16_t) (tmtr*10)) >> 0 
#define	TELEM_ITEM_124	((uint16_t) (tmtr*10)) >> 8 
#define	TELEM_ITEM_125	((uint8_t) (error_code*1)) >> 0 
