...
/// Last autogenerated: Wed May 16 21:23:59 2018
...
#define	TELEM_ITEM_155	((uint16_t) (last_packet_number*1)) >> 0 
#define	TELEM_ITEM_156	((uint16_t) (last_packet_number*1)) >> 8 
#define	TELEM_ITEM_157	((uint16_t) (last_command_id*1)) >> 0 
#define	TELEM_ITEM_158	((uint16_t) (last_command_id*1)) >> 8 
#define	TELEM_ITEM_159	((uint16_t) (imtr[0]*1000)) >> 0 
#define	TELEM_ITEM_160	((uint16_t) (imtr[0]*1000)) >> 8 
#define	TELEM_ITEM_161	((uint16_t) (imtr[1]*1000)) >> 0 
#define	TELEM_ITEM_162	((uint16_t) (imtr[1]*1000)) >> 8 
