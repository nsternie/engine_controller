...
/// Last autogenerated: Wed May  9 12:35:08 2018
...
#define	TELEM_ITEM_77	((int16_t) (ivlv[0]*1)) >> 0 
#define	TELEM_ITEM_78	((int16_t) (ivlv[0]*1)) >> 8 
#define	TELEM_ITEM_79	((int16_t) (ivlv[1]*1)) >> 0 
#define	TELEM_ITEM_80	((int16_t) (ivlv[1]*1)) >> 8 
#define	TELEM_ITEM_81	((int16_t) (ivlv[2]*1)) >> 0 
#define	TELEM_ITEM_82	((int16_t) (ivlv[2]*1)) >> 8 
#define	TELEM_ITEM_83	((int16_t) (ivlv[3]*1)) >> 0 
#define	TELEM_ITEM_84	((int16_t) (ivlv[3]*1)) >> 8 
#define	TELEM_ITEM_85	((int16_t) (ivlv[4]*1)) >> 0 
#define	TELEM_ITEM_86	((int16_t) (ivlv[4]*1)) >> 8 
#define	TELEM_ITEM_87	((int16_t) (ivlv[5]*1)) >> 0 
#define	TELEM_ITEM_88	((int16_t) (ivlv[5]*1)) >> 8 
#define	TELEM_ITEM_89	((int16_t) (ivlv[6]*1)) >> 0 
#define	TELEM_ITEM_90	((int16_t) (ivlv[6]*1)) >> 8 
#define	TELEM_ITEM_91	((int16_t) (ivlv[7]*1)) >> 0 
#define	TELEM_ITEM_92	((int16_t) (ivlv[7]*1)) >> 8 
#define	TELEM_ITEM_93	((int16_t) (evlv[0]*1)) >> 0 
#define	TELEM_ITEM_94	((int16_t) (evlv[0]*1)) >> 8 
#define	TELEM_ITEM_95	((int16_t) (evlv[1]*1)) >> 0 
#define	TELEM_ITEM_96	((int16_t) (evlv[1]*1)) >> 8 
#define	TELEM_ITEM_97	((int16_t) (evlv[2]*1)) >> 0 
#define	TELEM_ITEM_98	((int16_t) (evlv[2]*1)) >> 8 
#define	TELEM_ITEM_99	((int16_t) (evlv[3]*1)) >> 0 
#define	TELEM_ITEM_100	((int16_t) (evlv[3]*1)) >> 8 
#define	TELEM_ITEM_101	((int16_t) (evlv[4]*1)) >> 0 
#define	TELEM_ITEM_102	((int16_t) (evlv[4]*1)) >> 8 
#define	TELEM_ITEM_103	((int16_t) (evlv[5]*1)) >> 0 
#define	TELEM_ITEM_104	((int16_t) (evlv[5]*1)) >> 8 
#define	TELEM_ITEM_105	((int16_t) (evlv[6]*1)) >> 0 
#define	TELEM_ITEM_106	((int16_t) (evlv[6]*1)) >> 8 
#define	TELEM_ITEM_107	((int16_t) (evlv[7]*1)) >> 0 
#define	TELEM_ITEM_108	((int16_t) (evlv[7]*1)) >> 8 
