...
/// Last autogenerated: Mon May 21 16:32:52 2018
...
#define	TELEM_ITEM_64	((uint8_t) (STATE*1)) >> 0 
#define	TELEM_ITEM_65	((int16_t) (ivlv[0]*100)) >> 0 
#define	TELEM_ITEM_66	((int16_t) (ivlv[0]*100)) >> 8 
#define	TELEM_ITEM_67	((int16_t) (ivlv[1]*100)) >> 0 
#define	TELEM_ITEM_68	((int16_t) (ivlv[1]*100)) >> 8 
#define	TELEM_ITEM_69	((int16_t) (ivlv[2]*100)) >> 0 
#define	TELEM_ITEM_70	((int16_t) (ivlv[2]*100)) >> 8 
#define	TELEM_ITEM_71	((int16_t) (ivlv[3]*100)) >> 0 
#define	TELEM_ITEM_72	((int16_t) (ivlv[3]*100)) >> 8 
#define	TELEM_ITEM_73	((int16_t) (ivlv[4]*100)) >> 0 
#define	TELEM_ITEM_74	((int16_t) (ivlv[4]*100)) >> 8 
#define	TELEM_ITEM_75	((int16_t) (ivlv[5]*100)) >> 0 
#define	TELEM_ITEM_76	((int16_t) (ivlv[5]*100)) >> 8 
#define	TELEM_ITEM_77	((int16_t) (ivlv[6]*100)) >> 0 
#define	TELEM_ITEM_78	((int16_t) (ivlv[6]*100)) >> 8 
#define	TELEM_ITEM_79	((int16_t) (ivlv[7]*100)) >> 0 
#define	TELEM_ITEM_80	((int16_t) (ivlv[7]*100)) >> 8 
#define	TELEM_ITEM_81	((int16_t) (evlv[0]*100)) >> 0 
#define	TELEM_ITEM_82	((int16_t) (evlv[0]*100)) >> 8 
#define	TELEM_ITEM_83	((int16_t) (evlv[1]*100)) >> 0 
#define	TELEM_ITEM_84	((int16_t) (evlv[1]*100)) >> 8 
#define	TELEM_ITEM_85	((int16_t) (evlv[2]*100)) >> 0 
#define	TELEM_ITEM_86	((int16_t) (evlv[2]*100)) >> 8 
#define	TELEM_ITEM_87	((int16_t) (evlv[3]*100)) >> 0 
#define	TELEM_ITEM_88	((int16_t) (evlv[3]*100)) >> 8 
#define	TELEM_ITEM_89	((int16_t) (evlv[4]*100)) >> 0 
#define	TELEM_ITEM_90	((int16_t) (evlv[4]*100)) >> 8 
#define	TELEM_ITEM_91	((int16_t) (evlv[5]*100)) >> 0 
#define	TELEM_ITEM_92	((int16_t) (evlv[5]*100)) >> 8 
#define	TELEM_ITEM_93	((int16_t) (evlv[6]*100)) >> 0 
#define	TELEM_ITEM_94	((int16_t) (evlv[6]*100)) >> 8 
#define	TELEM_ITEM_95	((int16_t) (evlv[7]*100)) >> 0 
#define	TELEM_ITEM_96	((int16_t) (evlv[7]*100)) >> 8 
#define	TELEM_ITEM_97	((int32_t) (e3v*100)) >> 0 
#define	TELEM_ITEM_98	((int32_t) (e3v*100)) >> 8 
#define	TELEM_ITEM_99	((int32_t) (e3v*100)) >> 16 
#define	TELEM_ITEM_100	((int32_t) (e3v*100)) >> 24 
#define	TELEM_ITEM_101	((int32_t) (e5v*100)) >> 0 
#define	TELEM_ITEM_102	((int32_t) (e5v*100)) >> 8 
#define	TELEM_ITEM_103	((int32_t) (e5v*100)) >> 16 
#define	TELEM_ITEM_104	((int32_t) (e5v*100)) >> 24 
#define	TELEM_ITEM_105	((uint16_t) (BOARD_ID*1)) >> 0 
#define	TELEM_ITEM_106	((uint16_t) (BOARD_ID*1)) >> 8 
#define	TELEM_ITEM_107	((uint16_t) (last_packet_number*1)) >> 0 
#define	TELEM_ITEM_108	((uint16_t) (last_packet_number*1)) >> 8 
#define	TELEM_ITEM_109	((uint16_t) (last_command_id*1)) >> 0 
#define	TELEM_ITEM_110	((uint16_t) (last_command_id*1)) >> 8 
#define	TELEM_ITEM_111	((uint16_t) (imtr[0]*1000)) >> 0 
#define	TELEM_ITEM_112	((uint16_t) (imtr[0]*1000)) >> 8 
#define	TELEM_ITEM_113	((uint16_t) (imtr[1]*1000)) >> 0 
#define	TELEM_ITEM_114	((uint16_t) (imtr[1]*1000)) >> 8 
#define	TELEM_ITEM_115	((uint16_t) (tbrd*10)) >> 0 
#define	TELEM_ITEM_116	((uint16_t) (tbrd*10)) >> 8 
#define	TELEM_ITEM_117	((uint16_t) (tvlv*10)) >> 0 
#define	TELEM_ITEM_118	((uint16_t) (tvlv*10)) >> 8 
#define	TELEM_ITEM_119	((uint16_t) (tmtr*10)) >> 0 
#define	TELEM_ITEM_120	((uint16_t) (tmtr*10)) >> 8 
#define	TELEM_ITEM_121	((uint8_t) (error_code*1)) >> 0 
#define	TELEM_ITEM_122	((uint8_t) (LOGGING_ACTIVE*1)) >> 0 
#define	TELEM_ITEM_123	((uint16_t) (logfile->current_page*1)) >> 0 
#define	TELEM_ITEM_124	((uint16_t) (logfile->current_page*1)) >> 8 
#define	TELEM_ITEM_125	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_126	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_127	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_128	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_129	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_130	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_131	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_132	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_133	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_134	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_135	((uint8_t) (0*1)) >> 0 
#define	TELEM_ITEM_136	((uint8_t) (0*1)) >> 0 
