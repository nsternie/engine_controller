...
/// Last autogenerated: Fri Nov 10 21:49:47 2017
...
#define	TELEM_ITEM_64	((uint32_t) (count1*1)) >> 0 
#define	TELEM_ITEM_65	((uint32_t) (count1*1)) >> 8 
#define	TELEM_ITEM_66	((uint32_t) (count1*1)) >> 16 
#define	TELEM_ITEM_67	((uint32_t) (count1*1)) >> 24 
#define	TELEM_ITEM_68	((uint32_t) (count2*1)) >> 0 
#define	TELEM_ITEM_69	((uint32_t) (count2*1)) >> 8 
#define	TELEM_ITEM_70	((uint32_t) (count2*1)) >> 16 
#define	TELEM_ITEM_71	((uint32_t) (count2*1)) >> 24 
#define	TELEM_ITEM_72	((uint32_t) (count3*1)) >> 0 
#define	TELEM_ITEM_73	((uint32_t) (count3*1)) >> 8 
#define	TELEM_ITEM_74	((uint32_t) (count3*1)) >> 16 
#define	TELEM_ITEM_75	((uint32_t) (count3*1)) >> 24 
#define	TELEM_ITEM_76	((uint8_t) (STATE*1)) >> 0 
#define	TELEM_ITEM_77	((uint16_t) (load[0]*10)) >> 0 
#define	TELEM_ITEM_78	((uint16_t) (load[0]*10)) >> 8 
#define	TELEM_ITEM_79	((uint16_t) (load[1]*10)) >> 0 
#define	TELEM_ITEM_80	((uint16_t) (load[1]*10)) >> 8 
#define	TELEM_ITEM_81	((uint16_t) (load[2]*10)) >> 0 
#define	TELEM_ITEM_82	((uint16_t) (load[2]*10)) >> 8 
#define	TELEM_ITEM_83	((uint16_t) (load[3]*10)) >> 0 
#define	TELEM_ITEM_84	((uint16_t) (load[3]*10)) >> 8 
...
#define	TELEM_ITEM_89	((int16_t) (thermocouple[0]*1)) >> 0 
#define	TELEM_ITEM_90	((int16_t) (thermocouple[0]*1)) >> 8 
#define	TELEM_ITEM_91	((int16_t) (thermocouple[1]*1)) >> 0 
#define	TELEM_ITEM_92	((int16_t) (thermocouple[1]*1)) >> 8 
#define	TELEM_ITEM_93	((int16_t) (thermocouple[2]*1)) >> 0 
#define	TELEM_ITEM_94	((int16_t) (thermocouple[2]*1)) >> 8 
#define	TELEM_ITEM_95	((int16_t) (thermocouple[3]*1)) >> 0 
#define	TELEM_ITEM_96	((int16_t) (thermocouple[3]*1)) >> 8 
#define	TELEM_ITEM_97	((int16_t) (ivlv[0]*100)) >> 0 
#define	TELEM_ITEM_98	((int16_t) (ivlv[0]*100)) >> 8 
#define	TELEM_ITEM_99	((int16_t) (ivlv[1]*100)) >> 0 
#define	TELEM_ITEM_100	((int16_t) (ivlv[1]*100)) >> 8 
#define	TELEM_ITEM_101	((int16_t) (ivlv[2]*100)) >> 0 
#define	TELEM_ITEM_102	((int16_t) (ivlv[2]*100)) >> 8 
#define	TELEM_ITEM_103	((int16_t) (ivlv[3]*100)) >> 0 
#define	TELEM_ITEM_104	((int16_t) (ivlv[3]*100)) >> 8 
#define	TELEM_ITEM_105	((int16_t) (ivlv[4]*100)) >> 0 
#define	TELEM_ITEM_106	((int16_t) (ivlv[4]*100)) >> 8 
#define	TELEM_ITEM_107	((int16_t) (ivlv[5]*100)) >> 0 
#define	TELEM_ITEM_108	((int16_t) (ivlv[5]*100)) >> 8 
#define	TELEM_ITEM_109	((int16_t) (ivlv[6]*100)) >> 0 
#define	TELEM_ITEM_110	((int16_t) (ivlv[6]*100)) >> 8 
#define	TELEM_ITEM_111	((int16_t) (ivlv[7]*100)) >> 0 
#define	TELEM_ITEM_112	((int16_t) (ivlv[7]*100)) >> 8 
#define	TELEM_ITEM_113	((int16_t) (ivlv[15]*100)) >> 0 
#define	TELEM_ITEM_114	((int16_t) (ivlv[15]*100)) >> 8 
#define	TELEM_ITEM_115	((int16_t) (evlv[0]*100)) >> 0 
#define	TELEM_ITEM_116	((int16_t) (evlv[0]*100)) >> 8 
#define	TELEM_ITEM_117	((int16_t) (evlv[1]*100)) >> 0 
#define	TELEM_ITEM_118	((int16_t) (evlv[1]*100)) >> 8 
#define	TELEM_ITEM_119	((int16_t) (evlv[2]*100)) >> 0 
#define	TELEM_ITEM_120	((int16_t) (evlv[2]*100)) >> 8 
#define	TELEM_ITEM_121	((int16_t) (evlv[3]*100)) >> 0 
#define	TELEM_ITEM_122	((int16_t) (evlv[3]*100)) >> 8 
#define	TELEM_ITEM_123	((int16_t) (evlv[4]*100)) >> 0 
#define	TELEM_ITEM_124	((int16_t) (evlv[4]*100)) >> 8 
#define	TELEM_ITEM_125	((int16_t) (evlv[5]*100)) >> 0 
#define	TELEM_ITEM_126	((int16_t) (evlv[5]*100)) >> 8 
#define	TELEM_ITEM_127	((int16_t) (evlv[6]*100)) >> 0 
#define	TELEM_ITEM_128	((int16_t) (evlv[6]*100)) >> 8 
#define	TELEM_ITEM_129	((int16_t) (evlv[7]*100)) >> 0 
#define	TELEM_ITEM_130	((int16_t) (evlv[7]*100)) >> 8 
#define	TELEM_ITEM_131	((int16_t) (evlv[8]*100)) >> 0 
#define	TELEM_ITEM_132	((int16_t) (evlv[8]*100)) >> 8 
#define	TELEM_ITEM_133	((int16_t) (evlv[9]*100)) >> 0 
#define	TELEM_ITEM_134	((int16_t) (evlv[9]*100)) >> 8 
#define	TELEM_ITEM_135	((int16_t) (evlv[10]*100)) >> 0 
#define	TELEM_ITEM_136	((int16_t) (evlv[10]*100)) >> 8 
#define	TELEM_ITEM_137	((int16_t) (evlv[11]*100)) >> 0 
#define	TELEM_ITEM_138	((int16_t) (evlv[11]*100)) >> 8 
#define	TELEM_ITEM_139	((int16_t) (evlv[12]*100)) >> 0 
#define	TELEM_ITEM_140	((int16_t) (evlv[12]*100)) >> 8 
#define	TELEM_ITEM_141	((int16_t) (evlv[13]*100)) >> 0 
#define	TELEM_ITEM_142	((int16_t) (evlv[13]*100)) >> 8 
#define	TELEM_ITEM_143	((int16_t) (evlv[14]*100)) >> 0 
#define	TELEM_ITEM_144	((int16_t) (evlv[14]*100)) >> 8 
#define	TELEM_ITEM_145	((int16_t) (evlv[15]*100)) >> 0 
#define	TELEM_ITEM_146	((int16_t) (evlv[15]*100)) >> 8 
#define	TELEM_ITEM_147	((int16_t) (LOG_TO_AUTO*1)) >> 0 
#define	TELEM_ITEM_148	((int16_t) (LOG_TO_AUTO*1)) >> 8 
#define	TELEM_ITEM_149	((uint16_t) (auto_states*1)) >> 0 
#define	TELEM_ITEM_150	((uint16_t) (auto_states*1)) >> 8 
