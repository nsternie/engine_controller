...
/// Last autogenerated: Sat Nov 11 01:27:33 2017
...
#define	TELEM_ITEM_77	((int16_t) (load[0]*1)) >> 0 
#define	TELEM_ITEM_78	((int16_t) (load[0]*1)) >> 8 
#define	TELEM_ITEM_79	((int16_t) (load[1]*1)) >> 0 
#define	TELEM_ITEM_80	((int16_t) (load[1]*1)) >> 8 
#define	TELEM_ITEM_81	((int16_t) (load[2]*1)) >> 0 
#define	TELEM_ITEM_82	((int16_t) (load[2]*1)) >> 8 
#define	TELEM_ITEM_83	((int16_t) (load[3]*1)) >> 0 
#define	TELEM_ITEM_84	((int16_t) (load[3]*1)) >> 8 
