...
mtr_enable[0].clicked.connect(lambda: s2_command(TARGET_ADDRESS_FLIGHT, COMMAND_MOTOR_ENABLE, 1, [0]))
mtr_enable[1].clicked.connect(lambda: s2_command(TARGET_ADDRESS_FLIGHT, COMMAND_MOTOR_ENABLE, 1, [1]))
mtr_disable[0].clicked.connect(lambda: s2_command(TARGET_ADDRESS_FLIGHT, COMMAND_MOTOR_DISABLE, 1, [0]))
...
timer.start(10) # 100hz for 10 as arg
app.exec_()