...
class ECParse:
	...
	def parse_packet(self, packet):
		...
		self.log_string = str(time.clock())+','+str(self.valve_states)+','+str(self.pressure[0])+','+str(self.pressure[1])+','+str(self.pressure[2])+','+str(self.pressure[3])+','+str(self.pressure[4])+','+str(self.pressure[5])+','+str(self.pressure[6])+','+str(self.pressure[7])+','+str(self.pressure[8])+','+str(self.pressure[9])+','+str(self.pressure[10])+','+str(self.pressure[11])+','+str(self.pressure[12])+','+str(self.pressure[13])+','+str(self.pressure[14])+','+str(self.pressure[15])+','+str(self.samplerate)+','+str(self.motor_setpoint[0])+','+str(self.motor_setpoint[1])+','+str(self.main_cycle_time)+','+str(self.motor_cycle_time)+','+str(self.adc_cycle_time)+','+str(self.telemetry_cycle_time)+','+str(self.ebatt)+','+str(self.ibus)+','+str(self.telemetry_rate)+','+str(self.motor_control_gain[0])+','+str(self.motor_control_gain[1])+','+str(self.motor_control_gain[2])+','+str(self.motor_position[0])+','+str(self.motor_position[1])+','+str(self.motor_pwm[0])+','+str(self.motor_pwm[1])+','+str(self.count1)+','+str(self.count2)+','+str(self.count3)+','+str(self.STATE)+','+str(self.load[0])+','+str(self.load[1])+','+str(self.load[2])+','+str(self.load[3])+','+str(self.thrust_load)+','+str(self.thermocouple[0])+','+str(self.thermocouple[1])+','+str(self.thermocouple[2])+','+str(self.thermocouple[3])+','+str(self.ivlv[0])+','+str(self.ivlv[1])+','+str(self.ivlv[2])+','+str(self.ivlv[3])+','+str(self.ivlv[4])+','+str(self.ivlv[5])+','+str(self.ivlv[6])+','+str(self.ivlv[7])+','+str(self.ivlv[15])+','+str(self.evlv[0])+','+str(self.evlv[1])+','+str(self.evlv[2])+','+str(self.evlv[3])+','+str(self.evlv[4])+','+str(self.evlv[5])+','+str(self.evlv[6])+','+str(self.evlv[7])+','+str(self.evlv[8])+','+str(self.evlv[9])+','+str(self.evlv[10])+','+str(self.evlv[11])+','+str(self.evlv[12])+','+str(self.evlv[13])+','+str(self.evlv[14])+','+str(self.evlv[15])+','+str(self.LOG_TO_AUTO)+','+str(self.auto_states)+','