...
class ECParse:
	...
	def __init__(self):
		...
		self.items[118] = 'tc[8]' 
		self.items[119] = 'tc[9]' 
		self.items[120] = 'tc[10]' 
		self.items[121] = 'tc[11]' 
		self.items[122] = 'tc[12]' 
		self.items[123] = 'tc[13]' 
		self.items[124] = 'tc[14]' 
		self.items[125] = 'tc[15]' 
		self.items[126] = 'zero' 
		self.items[127] = 'zero' 
		self.items[128] = 'zero' 
		self.items[129] = 'zero' 
